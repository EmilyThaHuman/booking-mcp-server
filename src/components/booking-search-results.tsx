  ...
  return (
    <div className="w-full h-full overflow-hidden bg-transparent">
      <div className="relative w-full p-4 bg-transparent">
        <div
          ref={containerRef}
          className="flex gap-4 overflow-x-auto scroll-smooth p-1 bg-transparent"
        ...
        {/* Carousel Controls */}
        <div className="absolute top-1/2 left-0 right-0 flex justify-between -translate-y-1/2 z-10 px-2">
          <button
            onClick={scrollPrev}
            disabled={!showPrevButton}
            className={cn(
              "w-10 h-10 rounded-3xl bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600",
              "shadow-md cursor-pointer flex items-center justify-center transition-all duration-200",
