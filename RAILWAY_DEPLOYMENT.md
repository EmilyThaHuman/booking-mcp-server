# Railway Deployment Guide - Booking MCP Server
...
```bash
cd /Users/reedvogt/Documents/GitHub/booking-mcp-server
railway init
```
...
railway variables set BASE_URL="https://booking-mcp-server-production.up.railway.app"
...
- `RAPIDAPI_KEY` - RapidAPI key for Booking.com API
